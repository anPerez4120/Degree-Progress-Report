<?php $title = "IS IT Enterprise Management Requirements";?>
...
<html lang="en">
  <body>
    ...
    ?>
    <br>
    <h3>IS IT Enterprise Management: Major Electives</h3>
    <?php
    $queryM="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_IEM JOIN COURSES ON IS_REQUIREMENTS_IEM.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'M'";
    ...
    ?>
    <br>    
    <h3>IS IT Enterprise Management: Open Elective</h3>
    <?php
    $queryO="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_IEM JOIN COURSES ON IS_REQUIREMENTS_IEM.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'O'";
