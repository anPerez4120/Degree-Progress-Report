<?php $title = "IS Database Administration Requirements";?>
...
<html lang="en">
  <body>
    ...
    ?>
    <br>
    <h3>IS Database Administration: Major Electives</h3>
    <?php
    $queryM="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_DA JOIN COURSES ON IS_REQUIREMENTS_DA.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'M'";
    ...
    ?>
    <br>    
    <h3>IS Database Administration: Open Elective</h3>
    <?php
    $queryO="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_DA JOIN COURSES ON IS_REQUIREMENTS_DA.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'O'";
