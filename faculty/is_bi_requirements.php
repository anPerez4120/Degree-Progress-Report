...
<html lang="en">
  <body>
	...
	FROM IS_REQUIREMENTS_BI JOIN COURSES ON IS_REQUIREMENTS_BI.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'R'";
	...
	FROM IS_REQUIREMENTS_BI JOIN COURSES ON IS_REQUIREMENTS_BI.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'M'";
	...
	FROM IS_REQUIREMENTS_BI JOIN COURSES ON IS_REQUIREMENTS_BI.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'O'";
