<?php $title = "IS Business Analysis/Systems Analysis Requirements";?>
...
<html lang="en">
  <body>
    <div class="title-bar">
      <h1>IS Business Analysis/Systems Analysis Requirements</h1>
    </div>
    <div class="space"></div>
    <div class="search_bar">
      <a href="degree_requirements.php" class="btn btn-primary btn-sm" role="button">Look At Another Degree Requirement</a>
    </div>
	<h3>IS Business Analysis/Systems Analysis: Requirements</h3>
    <?php
    $queryR="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_BASA JOIN COURSES ON IS_REQUIREMENTS_BASA.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'R'";
    ...
    ?>
    <br>
    <h3>IS Business Analysis/Systems Analysis: Major Electives</h3>
    <?php
    $queryM="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_BASA JOIN COURSES ON IS_REQUIREMENTS_BASA.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'M'";
    ...
    ?>
    <br>    
    <h3>IS Business Analysis/Systems Analysis: Open Elective</h3>
    <?php
    $queryO="SELECT CID, SUBJECT, CAT_NUMBER, TITLE, CONSENT, LOCATION, AUTUMN, WINTER, SPRING, SUMMER
	FROM IS_REQUIREMENTS_BASA JOIN COURSES ON IS_REQUIREMENTS_BASA.CID = COURSES.COURSE_ID WHERE REQUIREMENT = 'O'";
